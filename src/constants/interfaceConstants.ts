...
export const generatedDBDataSourceName = (entityName: string): string => `Generated${entityName}DB${DataSourceName}`;
export const dbDataSourceName = (entityName: string): string => `${entityName}DBD${DataSourceName}`;
